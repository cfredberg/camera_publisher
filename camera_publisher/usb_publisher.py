    ...
    def __init__(self):
        ...
        if using_blue:
            ...
            if use_name:
                ...
                gst_str = f'gst-launch-1.0 v4l2src device="/dev/v4l/by-path/platform-3610000.usb-usb-0:2.{port}:1.0-video-index0" ! image/x-raw,width=320,height=240,framerate=25/1 ! videoconvert ! appsink'
        elif using_thick:

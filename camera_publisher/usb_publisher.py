    ...
    def __init__(self):
        ...
        if using_blue:
            ...
            if use_name:
                ...
                gst_str = f'gst-launch-1.0 v4l2src device="/dev/v4l/by-path/platform-3610000.usb-usb-0:{port}:1.0-video-index0" io-mode=2 ! image/jpeg,width=320,height=240,framerate=25/1 ! jpegdec ! videoconvert ! appsink'
        elif using_thick:
            ...
            if use_name:
                ...
                gst_str = f'gst-launch-1.0 v4l2src device="/dev/v4l/by-path/platform-3610000.usb-usb-0:{port}:1.0-video-index0" io-mode=2 ! image/jpeg,width=320,height=240,framerate=30/1 ! jpegdec ! videoconvert ! appsink'
        elif using_small:
            ...
            if use_name:
                ...
                gst_str = f'v4l2src device="/dev/v4l/by-path/platform-3610000.usb-usb-0:{port}:1.0-video-index0" io-mode=2 ! image/jpeg,width=320,height=240,framerate=15/1 ! jpegdec ! videoconvert ! appsink'
